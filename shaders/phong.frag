...
uniform bool lightEnabled[MAX_NUM_LIGHTS] = bool[] (
		true, true, true, true, true, true, true, true);
uniform vec3 c0c1c2[MAX_NUM_LIGHTS] = vec3[](
...
float attenuation(int i, float distToLightInEC)
{
	...
	return 1.0 / (c0c1c2[i][0] + c0c1c2[i][1]*distToLightInLDS + c0c1c2[i][2]*distToLightInLDS*distToLightInLDS);
}
